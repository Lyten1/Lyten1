...
public class AccountController {
    ...
    public ArrayList<Account> get() throws SQLException {
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.FOUND)
    public ArrayList<Account> findByStatus(@PathVariable("request_data") String requestData) throws SQLException {
        return accountDAO.findByStatus(requestData);
    }
